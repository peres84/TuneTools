...
export function OnboardingStep2({ onComplete, onBack }: OnboardingStep2Props) {
  const handleGoogleCalendar = () => {
    // Google Calendar OAuth not yet implemented
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 mb-6">
        ...
        <div className="relative">
          <button
            ...
            disabled={true}
            className="w-full py-3 bg-gray-200 dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 rounded-lg font-semibold text-gray-500 dark:text-gray-400 cursor-not-allowed transition-all flex items-center justify-center gap-3 opacity-60"
          >
        ...
        <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-4">
          Google Calendar integration is currently in development. You can skip this step and continue using TuneTools!
        </p>
      </div>
